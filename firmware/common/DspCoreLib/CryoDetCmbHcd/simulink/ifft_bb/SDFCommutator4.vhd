-- -------------------------------------------------------------
-- 
-- File Name: hdlsrc_IFFT_no_scale\t\SDFCommutator4.vhd
...
-- Source Path: t/IFFT/IFFT HDL Optimized/RADIX22FFT_SDF2_4/SDFCommutator4
-- Hierarchy Level: 3
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ARCHITECTURE rtl OF SDFCommutator4 IS
  ...
  COMPONENT dataXMEM_re_0_4_8x20b
    PORT( clk                             :   IN    std_logic;
  ...
  SIGNAL SDFCummutator_btf1_re_dly_next   : signed(19 DOWNTO 0);  -- sfix20_En15
  SIGNAL SDFCummutator_btf1_im_dly_next   : signed(19 DOWNTO 0);  -- sfix20_En15
...
BEGIN
  u_dataXMEM_re_0_4_8x20b : dataXMEM_re_0_4_8x20b
    PORT MAP( clk => clk,
              wr_din => std_logic_vector(xData_re),  -- sfix20_En15
              wr_addr => std_logic_vector(wrXAddr),  -- ufix3
              wr_en => wrXEnb,
              rd_addr => std_logic_vector(rdXAddr),  -- ufix3
              rd_dout => xX_re  -- sfix20_En15
              );

  u_dataXMEM_im_0_4 : dataXMEM_re_0_4_8x20b
    PORT MAP( clk => clk,
              wr_din => std_logic_vector(xData_im),  -- sfix20_En15
              wr_addr => std_logic_vector(wrXAddr),  -- ufix3
              wr_en => wrXEnb,
              rd_addr => std_logic_vector(rdXAddr),  -- ufix3
              rd_dout => xX_im  -- sfix20_En15
              );
