-- -------------------------------------------------------------
-- 
-- File Name: hdlsrc_IFFT_no_scale\t\SDFCommutator3.vhd
...
-- Source Path: t/IFFT/IFFT HDL Optimized/RADIX22FFT_SDF1_3/SDFCommutator3
-- Hierarchy Level: 3
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ARCHITECTURE rtl OF SDFCommutator3 IS
  ...
  COMPONENT dataXMEM_re_0_3_8x19b
    PORT( clk                             :   IN    std_logic;
...
BEGIN
  u_dataXMEM_re_0_3_8x19b : dataXMEM_re_0_3_8x19b
    PORT MAP( clk => clk,
              wr_din => std_logic_vector(xData_re),  -- sfix19_En15
              wr_addr => std_logic_vector(wrXAddr),  -- ufix3
              wr_en => wrXEnb,
              rd_addr => std_logic_vector(rdXAddr),  -- ufix3
              rd_dout => xX_re  -- sfix19_En15
              );

  u_dataXMEM_im_0_3 : dataXMEM_re_0_3_8x19b
    PORT MAP( clk => clk,
              wr_din => std_logic_vector(xData_im),  -- sfix19_En15
              wr_addr => std_logic_vector(wrXAddr),  -- ufix3
              wr_en => wrXEnb,
              rd_addr => std_logic_vector(rdXAddr),  -- ufix3
              rd_dout => xX_im  -- sfix19_En15
              );
  ...
  SDFCummutator_output : PROCESS (SDFCummutator_out_re, SDFCummutator_out_im, SDFCummutator_out_vld,
       ...
       SDFCummutator_xX_vld_reg, din_3_vld_dly, dinXTwdlf_re_signed,
