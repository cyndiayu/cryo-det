-- -------------------------------------------------------------
-- 
-- File Name: hdlsrc_IFFT_no_scale\t\dataXMEM_re_0_2_8x18b.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: dataXMEM_re_0_2_8x18b
-- Source Path: t/IFFT/IFFT HDL Optimized/RADIX22FFT_SDF2_2/SDFCommutator2/dataXMEM_re_0_2_8x18b
-- Hierarchy Level: 4
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY dataXMEM_re_0_2_8x18b IS
...
END dataXMEM_re_0_2_8x18b;


ARCHITECTURE rtl OF dataXMEM_re_0_2_8x18b IS

  -- Component Declarations
  COMPONENT SimpleDualPortRAM_8x18b
    PORT( clk                             :   IN    std_logic;
          wr_din                          :   IN    std_logic_vector(17 DOWNTO 0);  -- sfix18_En15
          wr_addr                         :   IN    std_logic_vector(2 DOWNTO 0);  -- ufix3
          wr_en                           :   IN    std_logic;  -- ufix1
...
BEGIN
  u_SimpleDualPortRAM_8x18b : SimpleDualPortRAM_8x18b
    PORT MAP( clk => clk,
