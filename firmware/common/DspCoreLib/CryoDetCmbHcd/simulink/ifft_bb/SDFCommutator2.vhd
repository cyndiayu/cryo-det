-- -------------------------------------------------------------
-- 
-- File Name: hdlsrc_IFFT_no_scale\t\SDFCommutator2.vhd
...
-- Source Path: t/IFFT/IFFT HDL Optimized/RADIX22FFT_SDF2_2/SDFCommutator2
-- Hierarchy Level: 3
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ARCHITECTURE rtl OF SDFCommutator2 IS
  ...
  COMPONENT dataXMEM_re_0_2_8x18b
    PORT( clk                             :   IN    std_logic;
...
BEGIN
  u_dataXMEM_re_0_2_8x18b : dataXMEM_re_0_2_8x18b
    PORT MAP( clk => clk,
              wr_din => std_logic_vector(xData_re),  -- sfix18_En15
              wr_addr => std_logic_vector(wrXAddr),  -- ufix3
              wr_en => wrXEnb,
              rd_addr => std_logic_vector(rdXAddr),  -- ufix3
              rd_dout => xX_re  -- sfix18_En15
              );

  u_dataXMEM_im_0_2 : dataXMEM_re_0_2_8x18b
    PORT MAP( clk => clk,
              wr_din => std_logic_vector(xData_im),  -- sfix18_En15
              wr_addr => std_logic_vector(wrXAddr),  -- ufix3
              wr_en => wrXEnb,
              rd_addr => std_logic_vector(rdXAddr),  -- ufix3
              rd_dout => xX_im  -- sfix18_En15
              );
  ...
  SDFCummutator_output : PROCESS (SDFCummutator_out_re, SDFCummutator_out_im, SDFCummutator_out_vld,
       ...
       SDFCummutator_xX_vld_reg, dout_1_1_vld, dinf_re_signed, dinf_im_signed,
