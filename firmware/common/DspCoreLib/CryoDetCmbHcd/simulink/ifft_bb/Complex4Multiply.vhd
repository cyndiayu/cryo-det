-- -------------------------------------------------------------
-- 
-- File Name: hdlsrc_IFFT_no_scale\t\Complex4Multiply.vhd
...
-- Source Path: t/IFFT/IFFT HDL Optimized/RADIX22FFT_SDF1_3/Complex4Multiply
-- Hierarchy Level: 3
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ARCHITECTURE rtl OF Complex4Multiply IS
  ...
  SIGNAL prod1_re                         : signed(34 DOWNTO 0);  -- sfix35_En29
  SIGNAL prod1_im                         : signed(34 DOWNTO 0);  -- sfix35_En29
  SIGNAL prod2_re                         : signed(34 DOWNTO 0);  -- sfix35_En29
  SIGNAL prod2_im                         : signed(34 DOWNTO 0);  -- sfix35_En29
  ...
  SIGNAL Complex4Add_prod_vld_reg2        : std_logic;
  ...
  SIGNAL Complex4Add_prod_vld_reg1_next   : std_logic;
  SIGNAL Complex4Add_prod_vld_reg2_next   : std_logic;
  SIGNAL Complex4Add_prod1_re_reg_next    : signed(34 DOWNTO 0);  -- sfix35_En29
  SIGNAL Complex4Add_prod1_im_reg_next    : signed(34 DOWNTO 0);  -- sfix35_En29
  SIGNAL Complex4Add_prod2_re_reg_next    : signed(34 DOWNTO 0);  -- sfix35_En29
  SIGNAL Complex4Add_prod2_im_reg_next    : signed(34 DOWNTO 0);  -- sfix35_En29
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset = '1' OR softReset = '1' THEN
        ...
        Complex4Add_prod_vld_reg2 <= '0';
      ELSE 
        Complex4Add_multRes_re_reg <= Complex4Add_multRes_re_reg_next;
        Complex4Add_multRes_im_reg <= Complex4Add_multRes_im_reg_next;
        Complex4Add_prod_vld_reg1 <= Complex4Add_prod_vld_reg1_next;
        Complex4Add_prod_vld_reg2 <= Complex4Add_prod_vld_reg2_next;
        Complex4Add_prod1_re_reg <= Complex4Add_prod1_re_reg_next;
        Complex4Add_prod1_im_reg <= Complex4Add_prod1_im_reg_next;
        Complex4Add_prod2_re_reg <= Complex4Add_prod2_re_reg_next;
        Complex4Add_prod2_im_reg <= Complex4Add_prod2_im_reg_next;
      END IF;
    END IF;
  END PROCESS Complex4Add_process;

  Complex4Add_output : PROCESS (Complex4Add_multRes_re_reg, Complex4Add_multRes_im_reg,
       Complex4Add_prod_vld_reg1, Complex4Add_prod_vld_reg2,
       Complex4Add_prod1_re_reg, Complex4Add_prod1_im_reg,
       Complex4Add_prod2_re_reg, Complex4Add_prod2_im_reg, prod1_re, prod2_re,
       prod1_im, prod2_im, prod_vld)
    VARIABLE sub_cast : signed(35 DOWNTO 0);
    VARIABLE sub_cast_0 : signed(35 DOWNTO 0);
    VARIABLE add_cast : signed(35 DOWNTO 0);
    VARIABLE add_cast_0 : signed(35 DOWNTO 0);
  BEGIN
    Complex4Add_multRes_re_reg_next <= Complex4Add_multRes_re_reg;
    Complex4Add_multRes_im_reg_next <= Complex4Add_multRes_im_reg;
    IF Complex4Add_prod_vld_reg1 = '1' THEN 
      sub_cast := resize(Complex4Add_prod1_re_reg, 36);
      sub_cast_0 := resize(Complex4Add_prod2_re_reg, 36);
      Complex4Add_multRes_re_reg_next <= sub_cast - sub_cast_0;
      add_cast := resize(Complex4Add_prod1_im_reg, 36);
      add_cast_0 := resize(Complex4Add_prod2_im_reg, 36);
      Complex4Add_multRes_im_reg_next <= add_cast + add_cast_0;
    END IF;
    Complex4Add_prod1_re_reg_next <= prod1_re;
    Complex4Add_prod1_im_reg_next <= prod1_im;
    Complex4Add_prod2_re_reg_next <= prod2_re;
    Complex4Add_prod2_im_reg_next <= prod2_im;
    Complex4Add_prod_vld_reg2_next <= Complex4Add_prod_vld_reg1;
    Complex4Add_prod_vld_reg1_next <= prod_vld;
    mulResFP_re <= Complex4Add_multRes_re_reg;
    mulResFP_im <= Complex4Add_multRes_im_reg;
    dinXTwdl_3_1_vld <= Complex4Add_prod_vld_reg2;
  END PROCESS Complex4Add_output;
