-- -------------------------------------------------------------
-- 
-- File Name: hdlsrc_IFFT_no_scale\t\RADIX22FFT_SDF1_1.vhd
...
-- Source Path: t/IFFT/IFFT HDL Optimized/RADIX22FFT_SDF1_1
-- Hierarchy Level: 2
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
BEGIN
  u_dataMEM_im_0_1 : dataMEM_re_0_1_8x17b
    PORT MAP( clk => clk,
              wr_din => wrData_im,  -- sfix17_En15
              wr_addr => wrAddr,  -- ufix3
              wr_en => wrEnb,
              rd_addr => rd_1_Addr,  -- ufix3
              rd_dout => x_im  -- sfix17_En15
              );

  u_dataMEM_re_0_1_8x17b : dataMEM_re_0_1_8x17b
    PORT MAP( clk => clk,
              wr_din => wrData_re,  -- sfix17_En15
              wr_addr => wrAddr,  -- ufix3
              wr_en => wrEnb,
              rd_addr => rd_1_Addr,  -- ufix3
              rd_dout => x_re  -- sfix17_En15
              );
