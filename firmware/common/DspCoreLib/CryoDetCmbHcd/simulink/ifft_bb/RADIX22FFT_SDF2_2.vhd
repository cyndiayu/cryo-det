-- -------------------------------------------------------------
-- 
-- File Name: hdlsrc_IFFT_no_scale\t\RADIX22FFT_SDF2_2.vhd
...
-- Source Path: t/IFFT/IFFT HDL Optimized/RADIX22FFT_SDF2_2
-- Hierarchy Level: 2
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ARCHITECTURE rtl OF RADIX22FFT_SDF2_2 IS
  ...
  COMPONENT dataMEM_re_0_2_4x18b
    PORT( clk                             :   IN    std_logic;
...
BEGIN
  u_dataMEM_im_0_2 : dataMEM_re_0_2_4x18b
    PORT MAP( clk => clk,
              wr_din => wrData_im,  -- sfix18_En15
              wr_addr => wrAddr,  -- ufix2
              wr_en => wrEnb,
              rd_addr => rd_2_Addr,  -- ufix2
              rd_dout => x_im  -- sfix18_En15
              );

  u_dataMEM_re_0_2_4x18b : dataMEM_re_0_2_4x18b
    PORT MAP( clk => clk,
              wr_din => wrData_re,  -- sfix18_En15
              wr_addr => wrAddr,  -- ufix2
              wr_en => wrEnb,
              rd_addr => rd_2_Addr,  -- ufix2
              rd_dout => x_re  -- sfix18_En15
              );
